...
<html lang="en">
    ...
    <body onload="window.print()">
        ...
        <table width="100%" style="border: 0;">
            ...
            <tr>
                <td>Total Item:</td>
                <td class="text-right">{{ formatkg($pembelian->total_item) }}</td>
            </tr>
            <tr>
                <td>Diskon:</td>
        ...
        <script>
            ...
            // Check if the height exceeds the limit and add a class to break pages if necessary
            if (height > 1000) { // Adjust the height limit as needed
